...
<html>
  ...
  <div id="content5">
    ...
    <div class="basbox">
    <ul>
      <h3> ---------------- Enregistrer un étudiants --------------- <h3><br/>
      <form method="post">
        <table>
          ...
          <tr><td><label>Numéro étudiant</label></td><td><input type="text" name="Numetu" id="Numetu"placeholder="Votre adresse" required></td></tr>
